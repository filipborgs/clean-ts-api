...
describe('DbAuthentication UseCase', () => {
  const mockLoadAccountByEmailRepositoryStub = (): LoadAccountByEmailRepository => {
    class LoadAccountByEmailRepositoryStub implements LoadAccountByEmailRepository {
      async loadByEmail (email: string): Promise<AccountModel | null> { return mockFakeAccount() }
    }
    return new LoadAccountByEmailRepositoryStub()
  }

  const mockHashCompareStub = (): HashCompare => {
  ...
  const mockTokenGeneratorStub = (): TokenGenerator => {
  ...
  const makeSut = (): SutTypes => {
    ...
    const hashComparerStub = mockHashCompareStub()
  ...
  test('Should call LoadAccountByEmailRepository with correct email', async () => {
    ...
    await sut.login(mockFakeAuthentication())
  ...
  test('should throw if LoadAccountByEmailRepository throws', async () => {
    ...
    const result = sut.login(mockFakeAuthentication())
  ...
  test('should return null if LoadAccountByEmailRepository retuns null', async () => {
    ...
    const token = await sut.login(mockFakeAuthentication())
  ...
  test('should call HashComparer with correct password', async () => {
    ...
    const authAccount = mockFakeAuthentication()
